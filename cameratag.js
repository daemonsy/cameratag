...
if (ct_browser()[0] == "Chrome" && ct_browser()[1] > 45) {
  ct_webrtc = true;
}
else if (ct_browser()[0] == "Firefox" && ct_browser()[1] > 39) {
  ct_webrtc = true;
}
else {
  ct_webrtc = false
...
// RecordRTC
if (ct_webrtc) {
  function RecordRTC(e,t){function i(){return!t.disableLogs,c?(c.clearRecordedData(),c.resume(),u.recordingDuration&&s(),u):(o(function(){u.recordingDuration&&s()}),u)}function o(i){!t.disableLogs,i&&(t.initCallback=function(){i(),i=t.initCallback=null});var o=new GetRecorderType(t);c=new o(e,t),c.record()}function a(e){function i(){for(var i in c)u&&(u[i]=c[i]),o&&(o[i]=c[i]);var a=c.blob;if(e){var n=URL.createObjectURL(a);e(n)}a&&!t.disableLogs,t.autoWriteToDisk&&d(function(e){var i={};i[t.type+"Blob"]=e,DiskStorage.Store(i)})}if(c){var o=this;!t.disableLogs,"gif"!==t.type?c.stop(i):(c.stop(),i())}}function n(){c&&(c.pause(),!t.disableLogs)}function r(){c&&(c.resume(),!t.disableLogs)}function d(e,i){function o(e){var t=URL.createObjectURL(new Blob([e.toString(),"this.onmessage =  function (e) {"+e.name+"(e.data);}"],{type:"application/javascript"})),i=new Worker(t);return URL.revokeObjectURL(t),i}if(!e)throw"Pass a callback function over getDataURL.";var a=i?i.blob:c.blob;if(!a)return!t.disableLogs,void setTimeout(function(){d(e,i)},1e3);if("undefined"!=typeof Worker){var n=o(function(e){postMessage((new FileReaderSync).readAsDataURL(e))});n.onmessage=function(t){e(t.data)},n.postMessage(a)}else{var r=new FileReader;r.readAsDataURL(a),r.onload=function(t){e(t.target.result)}}}function s(){setTimeout(function(){a(u.onRecordingStopped)},u.recordingDuration)}if(!e)throw"MediaStream is mandatory.";t=new RecordRTCConfiguration(e,t);var c,u=this,f=('It seems that "startRecording" is not invoked for '+t.type+" recorder.",{startRecording:i,stopRecording:a,pauseRecording:n,resumeRecording:r,initRecorder:o,setRecordingDuration:function(e,t){if("undefined"==typeof e)throw"milliseconds is required.";if("number"!=typeof e)throw"milliseconds must be a number.";return u.recordingDuration=e,u.onRecordingStopped=t||function(){},{onRecordingStopped:function(e){u.onRecordingStopped=e}}},clearRecordedData:function(){c&&(c.clearRecordedData(),!t.disableLogs)},getBlob:function(){return c?c.blob:void 0},getDataURL:d,toURL:function(){return c?URL.createObjectURL(c.blob):void 0},save:function(e){c&&invokeSaveAsDialog(c.blob,e)},getFromDisk:function(e){c&&RecordRTC.getFromDisk(t.type,e)},setAdvertisementArray:function(e){t.advertisement=[];for(var i=e.length,o=0;i>o;o++)t.advertisement.push({duration:o,image:e[o]})},blob:null,bufferSize:0,sampleRate:0,buffer:null,view:null});if(!this)return u=f,f;for(var l in f)this[l]=f[l];return u=this,f}function RecordRTCConfiguration(e,t){return t.recorderType&&!t.type&&(t.recorderType===WhammyRecorder||t.recorderType===CanvasRecorder?t.type="video":t.recorderType===GifRecorder?t.type="gif":t.recorderType===StereoAudioRecorder?t.type="audio":t.recorderType===MediaStreamRecorder&&(e.getAudioTracks().length&&e.getVideoTracks().length?t.type="video":e.getAudioTracks().length&&!e.getVideoTracks().length?t.type="audio":!e.getAudioTracks().length&&e.getVideoTracks().length&&(t.type="audio"))),"undefined"!=typeof MediaStreamRecorder&&"undefined"!=typeof MediaRecorder&&"requestData"in MediaRecorder.prototype&&(t.mimeType||(t.mimeType="video/webm"),t.type||(t.type=t.mimeType.split("/")[0]),t.bitsPerSecond||(t.bitsPerSecond=2097152)),t.type||(t.mimeType&&(t.type=t.mimeType.split("/")[0]),t.type||(t.type="audio")),t}function GetRecorderType(e){var t;return(isChrome||isEdge||isOpera)&&(t=StereoAudioRecorder),"undefined"!=typeof MediaRecorder&&"requestData"in MediaRecorder.prototype&&(t=MediaStreamRecorder),"video"===e.type&&(isChrome||isOpera)&&(t=WhammyRecorder),"gif"===e.type&&(t=GifRecorder),"canvas"===e.type&&(t=CanvasRecorder),e.recorderType&&(t=e.recorderType),t}function MRecordRTC(e){this.addStream=function(t){t&&(e=t)},this.mediaType={audio:!0,video:!0},this.startRecording=function(){!isChrome&&e&&e.getAudioTracks&&e.getAudioTracks().length&&e.getVideoTracks().length&&(this.mediaType.audio=!1),this.mediaType.audio&&(this.audioRecorder=new RecordRTC(e,{type:"audio",bufferSize:this.bufferSize,sampleRate:this.sampleRate}),this.audioRecorder.startRecording()),this.mediaType.video&&(this.videoRecorder=new RecordRTC(e,{type:"video",video:this.video,canvas:this.canvas}),this.videoRecorder.startRecording()),this.mediaType.gif&&(this.gifRecorder=new RecordRTC(e,{type:"gif",frameRate:this.frameRate||200,quality:this.quality||10}),this.gifRecorder.startRecording())},this.stopRecording=function(e){e=e||function(){},this.audioRecorder&&this.audioRecorder.stopRecording(function(t){e(t,"audio")}),this.videoRecorder&&this.videoRecorder.stopRecording(function(t){e(t,"video")}),this.gifRecorder&&this.gifRecorder.stopRecording(function(t){e(t,"gif")})},this.getBlob=function(e){var t={};return this.audioRecorder&&(t.audio=this.audioRecorder.getBlob()),this.videoRecorder&&(t.video=this.videoRecorder.getBlob()),this.gifRecorder&&(t.gif=this.gifRecorder.getBlob()),e&&e(t),t},this.getDataURL=function(e){function t(e,t){if("undefined"!=typeof Worker){var o=i(function(e){postMessage((new FileReaderSync).readAsDataURL(e))});o.onmessage=function(e){t(e.data)},o.postMessage(e)}else{var a=new FileReader;a.readAsDataURL(e),a.onload=function(e){t(e.target.result)}}}function i(e){var t,i=URL.createObjectURL(new Blob([e.toString(),"this.onmessage =  function (e) {"+e.name+"(e.data);}"],{type:"application/javascript"})),o=new Worker(i);if("undefined"!=typeof URL)t=URL;else{if("undefined"==typeof webkitURL)throw"Neither URL nor webkitURL detected.";t=webkitURL}return t.revokeObjectURL(i),o}this.getBlob(function(i){t(i.audio,function(o){t(i.video,function(t){e({audio:o,video:t})})})})},this.writeToDisk=function(){RecordRTC.writeToDisk({audio:this.audioRecorder,video:this.videoRecorder,gif:this.gifRecorder})},this.save=function(e){e=e||{audio:!0,video:!0,gif:!0},e.audio&&this.audioRecorder&&this.audioRecorder.save("string"==typeof e.audio?e.audio:""),e.video&&this.videoRecorder&&this.videoRecorder.save("string"==typeof e.video?e.video:""),e.gif&&this.gifRecorder&&this.gifRecorder.save("string"==typeof e.gif?e.gif:"")}}function bytesToSize(e){var t=1e3,i=["Bytes","KB","MB","GB","TB"];if(0===e)return"0 Bytes";var o=parseInt(Math.floor(Math.log(e)/Math.log(t)),10);return(e/Math.pow(t,o)).toPrecision(3)+" "+i[o]}function invokeSaveAsDialog(e,t){if(!e)throw"Blob object is required.";e.type||(e.type="video/webm");var i=e.type.split("/")[1];if(t&&-1!==t.indexOf(".")){var o=t.split(".");t=o[0],i=o[1]}var a=(t||Math.round(9999999999*Math.random())+888888888)+"."+i;if("undefined"!=typeof navigator.msSaveOrOpenBlob)return navigator.msSaveOrOpenBlob(e,a);if("undefined"!=typeof navigator.msSaveBlob)return navigator.msSaveBlob(e,a);var n=document.createElement("a");n.href=URL.createObjectURL(e),n.target="_blank",n.download=a,navigator.mozGetUserMedia&&(n.onclick=function(){(document.body||document.documentElement).removeChild(n)},(document.body||document.documentElement).appendChild(n));var r=new MouseEvent("click",{view:window,bubbles:!0,cancelable:!0});n.dispatchEvent(r),navigator.mozGetUserMedia||URL.revokeObjectURL(n.href)}function MediaStreamRecorder(e,t){function i(){if("active"in e){if(!e.active)return!1}else if("ended"in e&&e.ended)return!1}var o=this;if(t=t||{audioBitsPerSecond:128e3,videoBitsPerSecond:25e5,bitsPerSecond:128e3,mimeType:"video/webm"},t.mimeType&&"video/webm"!==t.mimeType&&e.getVideoTracks&&e.getVideoTracks().length){var a=new AudioContext,n=a.createMediaStreamSource(e),r=a.createMediaStreamDestination();n.connect(r),e=r.stream,t.mimeType&&-1!==t.mimeType.indexOf("audio")||(t.mimeType="audio/ogg")}var d=!1;this.record=function(){!t.disableLogs,s=new MediaRecorder(e,t),"canRecordMimeType"in s&&s.canRecordMimeType(t.mimeType)===!1&&!t.disableLogs,s.ignoreMutedMedia=t.ignoreMutedMedia||!1,s.ondataavailable=function(e){if(!o.dontFireOnDataAvailableEvent&&!d){if(!e.data.size)return void!t.disableLogs;d=!0,o.blob=new Blob([e.data],{type:e.data.type||t.mimeType||"audio/ogg"}),o.callback&&o.callback()}},s.onerror=function(e){t.disableLogs||"InvalidState"===e.name||"OutOfMemory"===e.name||"IllegalStreamModification"===e.name||"OtherRecordingError"===e.name||"GenericError"===e.name,"inactive"!==s.state&&"stopped"!==s.state&&s.stop()},s.start(0),t.onAudioProcessStarted&&t.onAudioProcessStarted(),t.initCallback&&t.initCallback()},this.stop=function(e){s&&(this.callback=e,"recording"===s.state&&s.stop())},this.pause=function(){s&&"recording"===s.state&&s.pause()},this.resume=function(){return s?this.dontFireOnDataAvailableEvent?(this.dontFireOnDataAvailableEvent=!1,d=!1,void this.record()):void("paused"===s.state&&s.resume()):void 0},this.clearRecordedData=function(){s&&(this.pause(),this.dontFireOnDataAvailableEvent=!0,this.stop())};var s;!function c(){return s?i()===!1?void s.stop():void setTimeout(c,1e3):void 0}()}function StereoAudioRecorder(e,t){function i(){if("active"in e){if(!e.active)return!1}else if("ended"in e&&e.ended)return!1}function o(e,t){function i(e,t){function i(e,t){for(var i=new Float64Array(t),o=0,a=e.length,n=0;a>n;n++){var r=e[n];i.set(r,o),o+=r.length}return i}function o(e,t){for(var i=e.length+t.length,o=new Float64Array(i),a=0,n=0;i>n;)o[n++]=e[a],o[n++]=t[a],a++;return o}function a(e,t,i){for(var o=i.length,a=0;o>a;a++)e.setUint8(t+a,i.charCodeAt(a))}var n=e.numberOfAudioChannels,r=e.leftBuffers.slice(0),d=e.rightBuffers.slice(0),s=e.sampleRate,c=e.internalInterleavedLength;2===n&&(r=i(r,c),d=i(d,c)),1===n&&(r=i(r,c));var u;2===n&&(u=o(r,d)),1===n&&(u=r);var f=u.length,l=44+2*f,m=new ArrayBuffer(l),h=new DataView(m);a(h,0,"RIFF"),h.setUint32(4,44+2*f,!0),a(h,8,"WAVE"),a(h,12,"fmt "),h.setUint32(16,16,!0),h.setUint16(20,1,!0),h.setUint16(22,n,!0),h.setUint32(24,s,!0),h.setUint32(28,4*s,!0),h.setUint16(32,2*n,!0),h.setUint16(34,16,!0),a(h,36,"data"),h.setUint32(40,2*f,!0);for(var g=f,v=44,p=1,b=0;g>b;b++)h.setInt16(v,32767*u[b]*p,!0),v+=2;return t?t({buffer:m,view:h}):void postMessage({buffer:m,view:h})}if(!isChrome)return void i(e,function(e){t(e.buffer,e.view)});var o=a(i);o.onmessage=function(e){t(e.data.buffer,e.data.view),URL.revokeObjectURL(o.workerURL)},o.postMessage(e)}function a(e){var t=URL.createObjectURL(new Blob([e.toString(),";this.onmessage =  function (e) {"+e.name+"(e.data);}"],{type:"application/javascript"})),i=new Worker(t);return i.workerURL=t,i}function n(e){if(!b){if(i()===!1&&(!t.disableLogs,r.disconnect(),u=!1),!u)return void h.disconnect();R||(R=!0,t.onAudioProcessStarted&&t.onAudioProcessStarted(),t.initCallback&&t.initCallback());var o=e.inputBuffer.getChannelData(0);if(s.push(new Float32Array(o)),2===l){var a=e.inputBuffer.getChannelData(1);c.push(new Float32Array(a))}f+=v}}if(!e.getAudioTracks().length)throw"Your stream has no audio tracks.";t=t||{};var r,d=this,s=[],c=[],u=!1,f=0,l=2;t.leftChannel===!0&&(l=1),1===t.numberOfAudioChannels&&(l=1),!t.disableLogs,this.record=function(){if(i()===!1)throw"Please make sure MediaStream is active.";s.length=c.length=0,f=0,h&&h.connect(r),R=b=!1,u=!0},this.stop=function(e){u=!1,o({sampleRate:p,numberOfAudioChannels:l,internalInterleavedLength:f,leftBuffers:s,rightBuffers:1===l?[]:c},function(t,i){d.blob=new Blob([i],{type:"audio/wav"}),d.buffer=new ArrayBuffer(i),d.view=i,d.sampleRate=p,d.bufferSize=v,d.length=f,e&&e(),R=!1})},Storage.AudioContextConstructor||(Storage.AudioContextConstructor=new Storage.AudioContext);var m=Storage.AudioContextConstructor,h=m.createMediaStreamSource(e),g=[0,256,512,1024,2048,4096,8192,16384],v="undefined"==typeof t.bufferSize?4096:t.bufferSize;if(-1===g.indexOf(v)&&!t.disableLogs,m.createJavaScriptNode)r=m.createJavaScriptNode(v,l,l);else{if(!m.createScriptProcessor)throw"WebAudio API has no support on this browser.";r=m.createScriptProcessor(v,l,l)}h.connect(r),t.bufferSize||(v=r.bufferSize);var p="undefined"!=typeof t.sampleRate?t.sampleRate:m.sampleRate||44100;(22050>p||p>96e3)&&!t.disableLogs,!t.disableLogs;var b=!1;this.pause=function(){b=!0},this.resume=function(){if(i()===!1)throw"Please make sure MediaStream is active.";return u?void(b=!1):(!t.disableLogs,void this.record())},this.clearRecordedData=function(){this.pause(),s.length=c.length=0,f=0};var R=!1;r.onaudioprocess=n,r.connect(m.destination)}function CanvasRecorder(e,t){function i(){return s?(c=(new Date).getTime(),setTimeout(i,100)):void html2canvas(e,{onrendered:function(e){if(o){var t=document.createElement("img");t.src=e.toDataURL("image/png"),t.onload=function(){n.drawImage(t,0,0,t.clientWidth,t.clientHeight),(document.body||document.documentElement).removeChild(t)},t.style.opacity=0,(document.body||document.documentElement).appendChild(t)}else{var a=(new Date).getTime()-c;if(!a)return i();c=(new Date).getTime(),u.frames.push({duration:a,image:e.toDataURL("image/webp")})}d&&setTimeout(i,0)}})}if("undefined"==typeof html2canvas)throw"Please link: //cdn.webrtc-experiment.com/screenshot.js";t=t||{};var o=!1;["captureStream","mozCaptureStream","webkitCaptureStream"].forEach(function(e){e in document.createElement("canvas")&&(o=!0)});var a,n,r;o?(!t.disableLogs,a=document.createElement("canvas"),a.width=e.clientWidth||window.innerWidth,a.height=e.clientHeight||window.innerHeight,a.style="top: -9999999; left: -99999999; visibility:hidden; position:absoluted; display: none;",(document.body||document.documentElement).appendChild(a),n=a.getContext("2d")):navigator.mozGetUserMedia&&(t.disableLogs||alert("Canvas recording is NOT supported in Firefox."));var d;this.record=function(){if(o){var e;if("captureStream"in a?e=a.captureStream(25):"mozCaptureStream"in a?e=a.captureStream(25):"webkitCaptureStream"in a&&(e=a.captureStream(25)),!e)throw"captureStream API are NOT available.";r=new MediaStreamRecorder(e,{mimeType:"video/webm"}),r.record()}d=!0,u.frames=[],i(),t.initCallback&&t.initCallback()},this.stop=function(e){if(d=!1,o&&r){return void r.stop(function(){for(var i in r)self[i]=r[i];e&&e(t.blob)})}var t=this;u.compile(function(i){t.blob=i,t.blob.forEach&&(t.blob=new Blob([],{type:"video/webm"})),e&&e(t.blob),u.frames=[]})};var s=!1;this.pause=function(){s=!0},this.resume=function(){s=!1},this.clearRecordedData=function(){this.pause(),u.frames=[]};var c=(new Date).getTime(),u=new Whammy.Video(100)}function WhammyRecorder(e,t){function i(e){e="undefined"!=typeof e?e:10;var t=(new Date).getTime()-d;return t?n?(d=(new Date).getTime(),setTimeout(i,100)):(d=(new Date).getTime(),r.paused&&r.play(),u.drawImage(r,0,0,c.width,c.height),s.frames.push({duration:t,image:c.toDataURL("image/webp")}),void(a||setTimeout(i,e,e))):setTimeout(i,e,e)}function o(e,t,i,o){var a=document.createElement("canvas");a.width=c.width,a.height=c.height;for(var n=a.getContext("2d"),r=[],d=-1===t,s=t&&t>0&&t<=e.length?t:e.length,u={r:0,g:0,b:0},f=Math.sqrt(Math.pow(255,2)+Math.pow(255,2)+Math.pow(255,2)),l=i&&i>=0&&1>=i?i:0,m=o&&o>=0&&1>=o?o:0,h=!1,g=0;s>g;g++){var v,p,b;if(!h){var R=new Image;R.src=e[g].image,n.drawImage(R,0,0,c.width,c.height);var w=n.getImageData(0,0,c.width,c.height);v=0,p=w.data.length,b=w.data.length/4;for(var y=0;p>y;y+=4){var S={r:w.data[y],g:w.data[y+1],b:w.data[y+2]},k=Math.sqrt(Math.pow(S.r-u.r,2)+Math.pow(S.g-u.g,2)+Math.pow(S.b-u.b,2));f*l>=k&&v++}}!h&&b*m>=b-v||(d&&(h=!0),r.push(e[g]))}return r=r.concat(e.slice(s)),r.length<=0&&r.push(e[e.length-1]),r}t=t||{},t.frameInterval||(t.frameInterval=10),!t.disableLogs,this.record=function(){t.width||(t.width=320),t.height||(t.height=240),t.video||(t.video={width:t.width,height:t.height}),t.canvas||(t.canvas={width:t.width,height:t.height}),c.width=t.canvas.width,c.height=t.canvas.height,u=c.getContext("2d"),t.video&&t.video instanceof HTMLVideoElement?(r=t.video.cloneNode(),t.initCallback&&t.initCallback()):(r=document.createElement("video"),"undefined"!=typeof r.srcObject?r.srcObject=e:r.src=URL.createObjectURL(e),r.onloadedmetadata=function(){t.initCallback&&t.initCallback()},r.width=t.video.width,r.height=t.video.height),r.muted=!0,r.play(),d=(new Date).getTime(),s=new Whammy.Video,!t.disableLogs,i(t.frameInterval)};var a=!1;this.stop=function(e){a=!0;var i=this;setTimeout(function(){s.frames=o(s.frames,-1),t.advertisement&&t.advertisement.length&&(s.frames=t.advertisement.concat(s.frames)),s.compile(function(t){i.blob=t,i.blob.forEach&&(i.blob=new Blob([],{type:"video/webm"})),e&&e(i.blob)})},10)};var n=!1;this.pause=function(){n=!0},this.resume=function(){n=!1},this.clearRecordedData=function(){this.pause(),s.frames=[]};var r,d,s,c=document.createElement("canvas"),u=c.getContext("2d")}function GifRecorder(e,t){if("undefined"==typeof GIFEncoder)throw"Please link: https://cdn.webrtc-experiment.com/gif-recorder.js";t=t||{};var i=e instanceof CanvasRenderingContext2D||e instanceof HTMLCanvasElement;this.record=function(){function e(d){return o?setTimeout(function(){e(d)},100):(f=requestAnimationFrame(e),void 0===typeof c&&(c=d),void(90>d-c||(!i&&r.paused&&r.play(),n.drawImage(r,0,0,a.width,a.height),t.onGifPreview&&t.onGifPreview(a.toDataURL("image/png")),u.addFrame(n),c=d)))}i||(t.width||(t.width=r.offsetWidth||320),this.height||(t.height=r.offsetHeight||240),t.video||(t.video={width:t.width,height:t.height}),t.canvas||(t.canvas={width:t.width,height:t.height}),a.width=t.canvas.width,a.height=t.canvas.height,r.width=t.video.width,r.height=t.video.height),u=new GIFEncoder,u.setRepeat(0),u.setDelay(t.frameRate||200),u.setQuality(t.quality||10),u.start(),d=Date.now();f=requestAnimationFrame(e),t.initCallback&&t.initCallback()},this.stop=function(){f&&cancelAnimationFrame(f),s=Date.now(),this.blob=new Blob([new Uint8Array(u.stream().bin)],{type:"image/gif"}),u.stream().bin=[]};var o=!1;this.pause=function(){o=!0},this.resume=function(){o=!1},this.clearRecordedData=function(){u&&(this.pause(),u.stream().bin=[])};var a=document.createElement("canvas"),n=a.getContext("2d");if(i&&(e instanceof CanvasRenderingContext2D?n=e:e instanceof HTMLCanvasElement&&(n=e.getContext("2d"))),!i){var r=document.createElement("video");r.muted=!0,r.autoplay=!0,"undefined"!=typeof r.srcObject?r.srcObject=e:r.src=URL.createObjectURL(e),r.play()}var d,s,c,u,f=null}if(RecordRTC.getFromDisk=function(e,t){if(!t)throw"callback is mandatory.";DiskStorage.Fetch(function(i,o){"all"!==e&&o===e+"Blob"&&t&&t(i),"all"===e&&t&&t(i,o.replace("Blob",""))})},RecordRTC.writeToDisk=function(e){e=e||{},e.audio&&e.video&&e.gif?e.audio.getDataURL(function(t){e.video.getDataURL(function(i){e.gif.getDataURL(function(e){DiskStorage.Store({audioBlob:t,videoBlob:i,gifBlob:e})})})}):e.audio&&e.video?e.audio.getDataURL(function(t){e.video.getDataURL(function(e){DiskStorage.Store({audioBlob:t,videoBlob:e})})}):e.audio&&e.gif?e.audio.getDataURL(function(t){e.gif.getDataURL(function(e){DiskStorage.Store({audioBlob:t,gifBlob:e})})}):e.video&&e.gif?e.video.getDataURL(function(t){e.gif.getDataURL(function(e){DiskStorage.Store({videoBlob:t,gifBlob:e})})}):e.audio?e.audio.getDataURL(function(e){DiskStorage.Store({audioBlob:e})}):e.video?e.video.getDataURL(function(e){DiskStorage.Store({videoBlob:e})}):e.gif&&e.gif.getDataURL(function(e){DiskStorage.Store({gifBlob:e})})},"undefined"!=typeof module&&(module.exports=RecordRTC),"function"==typeof define&&define.amd&&define("RecordRTC",[],function(){return RecordRTC}),MRecordRTC.getFromDisk=RecordRTC.getFromDisk,MRecordRTC.writeToDisk=RecordRTC.writeToDisk,"undefined"==typeof requestAnimationFrame){if("undefined"!=typeof webkitRequestAnimationFrame)var requestAnimationFrame=webkitRequestAnimationFrame;if("undefined"!=typeof mozRequestAnimationFrame)var requestAnimationFrame=mozRequestAnimationFrame}if("undefined"==typeof cancelAnimationFrame){if("undefined"!=typeof webkitCancelAnimationFrame)var cancelAnimationFrame=webkitCancelAnimationFrame;if("undefined"!=typeof mozCancelAnimationFrame)var cancelAnimationFrame=mozCancelAnimationFrame}if("undefined"==typeof AudioContext){if("undefined"!=typeof webkitAudioContext)var AudioContext=webkitAudioContext;if("undefined"!=typeof mozAudioContext)var AudioContext=mozAudioContext}if("undefined"==typeof URL&&"undefined"!=typeof webkitURL)var URL=webkitURL;var isEdge=!(-1===navigator.userAgent.indexOf("Edge")||!navigator.msSaveBlob&&!navigator.msSaveOrOpenBlob),isOpera=!!window.opera||-1!==navigator.userAgent.indexOf("OPR/"),isChrome=!isOpera&&!isEdge&&!!navigator.webkitGetUserMedia;if("undefined"!=typeof navigator)"undefined"!=typeof navigator.webkitGetUserMedia&&(navigator.getUserMedia=navigator.webkitGetUserMedia),"undefined"!=typeof navigator.mozGetUserMedia&&(navigator.getUserMedia=navigator.mozGetUserMedia);else var navigator={getUserMedia:{}};if("undefined"!=typeof webkitMediaStream)var MediaStream=webkitMediaStream;"undefined"!=typeof location&&0===location.href.indexOf("file:");var Storage={};"undefined"!=typeof AudioContext?Storage.AudioContext=AudioContext:"undefined"!=typeof webkitAudioContext&&(Storage.AudioContext=webkitAudioContext);var Whammy=function(){function e(e){this.frames=[],this.duration=e||1,this.quality=.8}function t(e){var t=URL.createObjectURL(new Blob([e.toString(),"this.onmessage =  function (e) {"+e.name+"(e.data);}"],{type:"application/javascript"})),i=new Worker(t);return URL.revokeObjectURL(t),i}function i(e){function t(e){var t=o(e);if(!t)return[];for(var a=3e4,n=[{id:440786851,data:[{data:1,id:17030},{data:1,id:17143},{data:4,id:17138},{data:8,id:17139},{data:"webm",id:17026},{data:2,id:17031},{data:2,id:17029}]},{id:408125543,data:[{id:357149030,data:[{data:1e6,id:2807729},{data:"whammy",id:19840},{data:"whammy",id:22337},{data:l(t.duration),id:17545}]},{id:374648427,data:[{id:174,data:[{data:1,id:215},{data:1,id:29637},{data:0,id:156},{data:"und",id:2274716},{data:"V_VP8",id:134},{data:"VP8",id:2459272},{data:1,id:131},{id:224,data:[{data:t.width,id:176},{data:t.height,id:186}]}]}]}]}],r=0,s=0;r<e.length;){var c=[],u=0;do c.push(e[r]),u+=e[r].duration,r++;while(r<e.length&&a>u);var f=0,m={id:524531317,data:i(s,f,c)};n[1].data.push(m),s+=u}return d(n)}function i(e,t,i){return[{data:e,id:231}].concat(i.map(function(e){var i=s({discardable:0,frame:e.data.slice(4),invisible:0,keyframe:1,lacing:0,trackNum:1,timecode:Math.round(t)});return t+=e.duration,{data:i,id:163}}))}function o(e){if(!e[0])return void postMessage({error:"Something went wrong. Maybe WebP format is not supported in the current browser."});for(var t=e[0].width,i=e[0].height,o=e[0].duration,a=1;a<e.length;a++)o+=e[a].duration;return{duration:o,width:t,height:i}}function a(e){for(var t=[];e>0;)t.push(255&e),e>>=8;return new Uint8Array(t.reverse())}function n(e){return new Uint8Array(e.split("").map(function(e){return e.charCodeAt(0)}))}function r(e){var t=[],i=e.length%8?new Array(9-e.length%8).join("0"):"";e=i+e;for(var o=0;o<e.length;o+=8)t.push(parseInt(e.substr(o,8),2));return new Uint8Array(t)}function d(e){for(var t=[],i=0;i<e.length;i++){var o=e[i].data;"object"==typeof o&&(o=d(o)),"number"==typeof o&&(o=r(o.toString(2))),"string"==typeof o&&(o=n(o));var s=o.size||o.byteLength||o.length,c=Math.ceil(Math.ceil(Math.log(s)/Math.log(2))/8),u=s.toString(2),f=new Array(7*c+7+1-u.length).join("0")+u,l=new Array(c).join("0")+"1"+f;t.push(a(e[i].id)),t.push(r(l)),t.push(o)}return new Blob(t,{type:"video/webm"})}function s(e){var t=0;if(e.keyframe&&(t|=128),e.invisible&&(t|=8),e.lacing&&(t|=e.lacing<<1),e.discardable&&(t|=1),e.trackNum>127)throw"TrackNumber > 127 not supported";var i=[128|e.trackNum,e.timecode>>8,255&e.timecode,t].map(function(e){return String.fromCharCode(e)}).join("")+e.frame;return i}function c(e){for(var t=e.RIFF[0].WEBP[0],i=t.indexOf("Â*"),o=0,a=[];4>o;o++)a[o]=t.charCodeAt(i+3+o);var n,r,d;return d=a[1]<<8|a[0],n=16383&d,d=a[3]<<8|a[2],r=16383&d,{width:n,height:r,data:t,riff:e}}function u(e,t){return parseInt(e.substr(t+4,4).split("").map(function(e){var t=e.charCodeAt(0).toString(2);return new Array(8-t.length+1).join("0")+t}).join(""),2)}function f(e){for(var t=0,i={};t<e.length;){var o=e.substr(t,4),a=u(e,t),n=e.substr(t+4+4,a);t+=8+a,i[o]=i[o]||[],i[o].push("RIFF"===o||"LIST"===o?f(n):n)}return i}function l(e){return[].slice.call(new Uint8Array(new Float64Array([e]).buffer),0).map(function(e){return String.fromCharCode(e)}).reverse().join("")}var m=new t(e.map(function(e){var t=c(f(atob(e.image.slice(23))));return t.duration=e.duration,t}));return navigator.mozGetUserMedia?m:void postMessage(m)}return e.prototype.add=function(e,t){if("canvas"in e&&(e=e.canvas),"toDataURL"in e&&(e=e.toDataURL("image/webp",this.quality)),!/^data:image\/webp;base64,/gi.test(e))throw"Input must be formatted properly as a base64 encoded DataURI of type image/webp";this.frames.push({image:e,duration:t||this.duration})},e.prototype.compile=function(e){if(navigator.mozGetUserMedia)return void e(i(this.frames));var o=t(i);o.onmessage=function(t){t.data.error||e(t.data)},o.postMessage(this.frames)},{Video:e}}(),DiskStorage={init:function(){function e(e){e.createObjectStore(i.dataStoreName)}function t(){function e(e){t.objectStore(i.dataStoreName).get(e).onsuccess=function(t){i.callback&&i.callback(t.target.result,e)}}var t=o.transaction([i.dataStoreName],"readwrite");i.videoBlob&&t.objectStore(i.dataStoreName).put(i.videoBlob,"videoBlob"),i.gifBlob&&t.objectStore(i.dataStoreName).put(i.gifBlob,"gifBlob"),i.audioBlob&&t.objectStore(i.dataStoreName).put(i.audioBlob,"audioBlob"),e("audioBlob"),e("videoBlob"),e("gifBlob")}var i=this;if("undefined"!=typeof indexedDB&&"undefined"!=typeof indexedDB.open){"undefined"!=typeof webkitIndexedDB&&(indexedDB=webkitIndexedDB),"undefined"!=typeof mozIndexedDB&&(indexedDB=mozIndexedDB),"undefined"!=typeof OIndexedDB&&(indexedDB=OIndexedDB),"undefined"!=typeof msIndexedDB&&(indexedDB=msIndexedDB);var o,a=1,n=this.dbName||location.href.replace(/\/|:|#|%|\.|\[|\]/g,""),r=indexedDB.open(n,a);r.onerror=i.onError,r.onsuccess=function(){if(o=r.result,o.onerror=i.onError,o.setVersion)if(o.version!==a){var n=o.setVersion(a);n.onsuccess=function(){e(o),t()}}else t();else t()},r.onupgradeneeded=function(t){e(t.target.result)}}},Fetch:function(e){return this.callback=e,this.init(),this},Store:function(e){return this.audioBlob=e.audioBlob,this.videoBlob=e.videoBlob,this.gifBlob=e.gifBlob,this.init(),this},onError:function(){},dataStoreName:"recordRTC",dbName:null};
}
        ...
        self.connect = function() {
            ...
            navigator.getUserMedia({
                ...
                recordAudio = RecordRTC(wrtc_stream, {
                    ...
                    bufferSize:16384 // force WebAudio for all browsers even for Firefox/MS-Edge
                });
            ...
            complete: function(){
              ...
              uploader.add({
                ...
                complete: function(){
                  ...
                  if (publishOnUpload) {
                   wait(CT_i18n[38]);
                   // call p_o_s directly so we dont upload
