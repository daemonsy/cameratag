    ...
    var CameraTagRecorder = function(camera_el) {
      ...
      var init = function() {
        ...
        if (camera.formats && ct_webrtc) {
          ...
          hResolution = camera.formats[0].height < 360 ? camera.formats[0].width : camera.formats[0].width / 2;
          vResolution = camera.formats[0].height < 360 ? camera.formats[0].height : camera.formats[0].height / 2;
      ...
      var setupEventObservers = function() {
        ...
        CameraTag.observe(dom_id, "paused", function() {
          console.log("paused recieved");
          paused_timer = setTimeout(function(){
            console.log("actually paused");
            paused = true;
            container.find(".cameratag_screen").hide();
            paused_screen.show();  
          }, 1500);
